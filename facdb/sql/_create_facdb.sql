...
SELECT
    ...
    facdb_agency.optype,
    COALESCE(facdb_agency.overagency, facdb_base.overagency),
    COALESCE(facdb_agency.overabbrev, facdb_base.overabbrev),
    COALESCE(facdb_agency.overlevel, facdb_base.overlevel),
    facdb_base.capacity,
    facdb_base.captype,
    facdb_base.proptype,
    facdb_geom.latitude,
