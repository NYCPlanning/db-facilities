...
WITH _dcp_colp_tmp AS(
    SELECT uid,
        ...
        (
            ...
            END)
        WHEN parcelname <> ' '
        AND parcelname IS NOT NULL
        AND upper(usetype) LIKE '%OFFICE%'
 THEN initcap(parcelname)||' - '||(
            CASE
                WHEN agency = 'HYDC' THEN 'HYDC'
                WHEN agency = 'MTA' THEN 'MTA'
                WHEN agency = 'NYCTA' THEN 'MTA'
        ...
        (
            CASE
                ...
                WHEN usetype LIKE '%OTHER HEALTH%'
                AND parcelname LIKE '%ANIMAL%' THEN 'Miscellaneous Use'
                WHEN agency LIKE '%DCA%'
                ...
                WHEN usetype LIKE '%COMMUNITY CENTER%'
                OR (
                    agency LIKE '%HRA%'
                ...
                WHEN agency LIKE '%CORR%'
                AND usetype LIKE '%COURT%' THEN 'Courthouses and Judicial'
                WHEN agency LIKE '%COURT%'
                AND usetype LIKE '%COURT%' THEN 'Courthouses and Judicial'
                WHEN agency LIKE '%OCA%'
                AND usetype LIKE '%COURT%' THEN 'Courthouses and Judicial'
        ...
        (
            CASE
                ...
                WHEN agency LIKE 'CB%' THEN REPLACE(
                    CONCAT(
                        'NYC ',
                        initcap(borough),
                        ' Community Board ',
